...
import com.zovvo.tastaz.loginModule.Fragment.Adapter.CartAdapter;
import com.zovvo.tastaz.loginModule.Fragment.Adapter.VolleySingleton;
import com.zovvo.tastaz.loginModule.Fragment.Fragment.PopularFragment;
...
import static com.zovvo.tastaz.loginModule.Fragment.Adapter.ProductAdapter.cartModels;
...
public class CartActivity extends AppCompatActivity {
    ...
    TextView lon, lat, price, email, name, contact,model,productid,title,textcart;
    ...
    private static String cart_url = "http://dashboard.tas-taz.com/api/order";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface text_city = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        textcart.setTypeface(text_city);
