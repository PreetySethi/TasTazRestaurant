...
import java.util.Map;
   ...
   public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passcase = (TextView) findViewById(R.id.passwordcase);
        Typeface passtitle = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        passcase.setTypeface(passtitle);

        ecase = (TextView) findViewById(R.id.emailcase);
        Typeface ectitle = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        ecase.setTypeface(ectitle);
