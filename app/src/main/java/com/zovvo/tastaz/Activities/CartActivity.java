...
import static com.zovvo.tastaz.Adapter.ProductAdapter.cartModel;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface title_text = Typeface.createFromAsset(getAssets(),  "fonts/NevisBold-KGwl.ttf");
        title.setTypeface(title_text);

         address2 = (EditText) findViewById(R.id.addressone);
        Typeface pick_text2 = Typeface.createFromAsset(getAssets(),  "fonts/NevisBold-KGwl.ttf");
        address2.setTypeface(pick_text2);

        city = (EditText) findViewById(R.id.txt_city);
        Typeface pick_city = Typeface.createFromAsset(getAssets(),  "fonts/NevisBold-KGwl.ttf");
