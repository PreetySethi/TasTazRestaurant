...
import com.zovvo.tastaz.loginModule.Fragment.Activities.MainActivity;
import com.zovvo.tastaz.loginModule.Fragment.Activities.MapsActivity;
...
public class MyLocationUsingLocationAPI extends AppCompatActivity implements ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface contact_text = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        ...
        Typeface here_text = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        here.setTypeface(here_text);


        TextView address= (TextView) findViewById(R.id.tvAddress);
        Typeface address_text = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        address.setTypeface(address_text);

        TextView loc= (TextView) findViewById(R.id.txt_loc);
        Typeface loc_text = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        loc.setTypeface(loc_text);

        TextView nam= (TextView) findViewById(R.id.nameg);
        Typeface nam_text = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        nam.setTypeface(nam_text);

        TextView show= (TextView) findViewById(R.id.textshow);
        Typeface show_text = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        show.setTypeface(show_text);

        TextView sho= (TextView) findViewById(R.id.textshoww);
        Typeface sho_text = Typeface.createFromAsset(getAssets(),  "fonts/Sansation_Regular.ttf");
        sho.setTypeface(sho_text);
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               //showToast("Proceed to the next step");
                Intent intent = new Intent(MyLocationUsingLocationAPI.this, MainActivity.class);
                startActivity(intent);
            }
        });
