...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    private static String reset_url = "http://192.168.8.130/tas-taz/public/api/forget";
    ...
    private void resetpassword() {
        ...
        String access_token = (String) SharedPref.getaccess_token(ForgotPasswordActivity.this);
