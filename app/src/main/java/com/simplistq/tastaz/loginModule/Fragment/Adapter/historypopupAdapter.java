...
import com.simplistq.tastaz.loginModule.Fragment.Model.OrderPopup;
...
public class historypopupAdapter extends RecyclerView.Adapter<historypopupAdapter.CustomViewHolder> {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Typeface pay_text = Typeface.createFromAsset(itemView.getContext().getAssets(),  "fonts/Sansation_Regular.ttf");
        pay.setTypeface(pay_text);

        TextView order = (TextView) itemView.findViewById(R.id.txt_orderid);
        Typeface order_text = Typeface.createFromAsset(itemView.getContext().getAssets(),  "fonts/Sansation_Regular.ttf");
