...
import com.simplistq.tastaz.loginModule.Fragment.Model.History;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.CustomViewHolder> {
    ...
    public HistoryAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Typeface or_text = Typeface.createFromAsset(itemView.getContext().getAssets(),  "fonts/Sansation_Regular.ttf");
        or.setTypeface(or_text);

        TextView date = (TextView) itemView.findViewById(R.id.date);
        Typeface date_text = Typeface.createFromAsset(itemView.getContext().getAssets(),  "fonts/Sansation_Regular.ttf");
        date.setTypeface(date_text);

       /* TextView view = (TextView) itemView.findViewById(R.id.order_view);
        Typeface view_text = Typeface.createFromAsset(itemView.getContext().getAssets(),  "fonts/Sansation_Regular.ttf");
        view.setTypeface(view_text);*/

       /* TextView deliveryboy = (TextView) itemView.findViewById(R.id.tv_deliveryboy);
        Typeface deliveryboy_text = Typeface.createFromAsset(itemView.getContext().getAssets(),  "fonts/Sansation_Regular.ttf");
